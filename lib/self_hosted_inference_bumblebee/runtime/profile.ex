defmodule SelfHostedInferenceBumblebee.Runtime.Profile do
  @moduledoc """
  ...
  No `lib/**` code reads OS environment variables to pick the profile — the
  caller decides, either by a Mix task flag, a `Config.Provider`, or an explicit
  struct.
  """
  ...
  def resolve(other) do
    raise ArgumentError,
          "unknown runtime profile #{inspect(other)}; " <>
            ...
            "or pass a %SelfHostedInferenceBumblebee.Runtime.Profile{} struct or {:custom, backend, opts}"
  end
  ...
  `SelfHostedInferenceBumblebee.Runtime.Preflight.tensor_backend/1`) is one this profile
  accepts.
  ...
  ## Examples
      ...
      iex> profile = SelfHostedInferenceBumblebee.Runtime.Profile.resolve(:cuda_exla)
      iex> SelfHostedInferenceBumblebee.Runtime.Profile.accepts_backend_label?(profile, "EXLA.Backend<cuda:0>")
      true
      iex> SelfHostedInferenceBumblebee.Runtime.Profile.accepts_backend_label?(profile, "EMLX.Backend")
      false
  """
